...
1. Administrator serwera powinien ustawić **wymaganą rolę do streamowania**. Jeśli rola zostanie ustawiona, tylko użytkownicy posiadający tę rolę będą mogli połączyć się z botem i przesyłać audio na kanał głosowy.
	1. Z poziomu czatu Discorda należy wpisać komendę "/setup role".
	1. Należy wybrać rolę, która umożliwi korzystanie z bota i przesyłanie audio.
