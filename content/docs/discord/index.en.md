...
1. The server administrator should set the **required streaming role**. If a role is set, only users with that role will be able to connect to the bot and stream audio to the voice channel.
