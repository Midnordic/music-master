...
{{< figure src="popup_menu.jpg" caption="Menu edytora." class="docs-img" >}}
...
{{< figure src="mix_ambient_editor.jpg" link="mix_ambient_editor.jpg" caption="Ambientowy miks z podpiętymi utworami." class="docs-img" >}}

### Widok odtwarzania

Gdy miks jest odtwarzany, prezentuje się następująco.

{{< figure src="mix_ambient_playing.jpg" link="mix_ambient_playing.jpg" caption="Ambientowy miks podczas odtwarzania." class="docs-img" >}}
...
{{< figure src="mix_crossfade_editor.jpg" link="mix_crossfade_editor.jpg" caption="Miks przejścia z podpiętymi utworami." class="docs-img" >}}
...
{{< figure src="mix_crossfade_playing.jpg" link="mix_crossfade_playing.jpg" caption="Miks przejścia podczas odtwarzania." class="docs-img" >}}
...
{{< figure src="effects.jpg" link="effects.jpg" caption="Miks z podpiętym mikserem efektów dźwiękowych." class="docs-img" >}}
