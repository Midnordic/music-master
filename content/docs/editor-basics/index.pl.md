...
- zresetować przybliżenie do 100%  
- zwiększyć przybliżenie  
- włączyć / wyłączyć mini-mapę (wyświetlaną w prawym dolnym rogu)  
- ustawić wybrane elementy pionowo  
- przywrócić poprzednie ustawienie elementów

Widok można również przybliżać i oddalać za pomocą rolki myszy lub gestu „szczypania” dwoma palcami na urządzeniach mobilnych.

## Dodawanie elementów

Elementy dodaje się za pomocą menu podręcznego. Aby je wywołać:
...
Aby dodać utwór (lub cały folder), wybierz z menu podręcznego opcję **„Add Track(s)”** lub **„Add Folder...”**.
...
Każdy element w edytorze posiada **sloty**, które można łączyć z innymi slotami. Połączenia te umożliwiają automatyzację wielu procesów zachodzących podczas odtwarzania utworów. Więcej o automatyzacji przeczytasz [tutaj](/docs/events). Teraz skupmy się na prostym połączeniu dwóch slotów.
...
Ten artykuł wyjaśnia jedynie, jak poruszać się po edytorze i pracować z jego elementami.  
Aby nauczyć się korzystać z konkretnych elementów edytora, przejdź do kolejnych artykułów.
