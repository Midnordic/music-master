...
**NOTE:** Removing a track from the composition will also remove it from all other places — playlists, the editor, and playback. All connections to and from that element will be lost.
