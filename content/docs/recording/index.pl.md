...
icon: "🎤"
description: "Nagrywaj dźwięk i dodawaj efekty."
weight: 45
---

Music Master umożliwia nagrywanie dźwięku. Dzięki temu możesz nagrać swój głos, bądź instrument, i dodać do niego różne, ciekawe efekty.
...
Przed rozpoczęciem nagrywania można wybrać efekty, które zostaną nałożone na nagrywaną ścieżkę dźwiękową.
...
Aby rozpocząć nagrywanie, naciśnij przycisk **"Record"**.

Jeśli nie chcesz słyszeć brzmienia nagrywanego dźwięku, odznacz pole **"Hear recording"**.

Po zakończeniu nagrywania naciśnij przycisk **"Stop"**.

Gotowe nagranie można odsłuchać poprzez naciśnięcie przycisku **"Play"**.

## Dodanie nagrania do kompozycji
