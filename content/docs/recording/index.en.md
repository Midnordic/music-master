...
icon: "🎤"
description: "Record audio with applied effects."
weight: 45
---
...
From the import menu, select **"Import Recording..."**.

{{< figure src="menu.jpg" link="menu.jpg" caption="Import menu." class="docs-img" >}}

The following recording window will open.

{{< figure src="window.jpg" link="window.jpg" caption="Recording window." class="docs-img" >}}
...
Only dual-channel microphones are supported. Selecting a different type of microphone may cause recording issues.
{{< /tip >}}
...
{{< figure src="effects.jpg" link="effects.jpg" caption="Effects menu." class="docs-img" >}}
...
{{< figure src="effects_added.jpg" link="effects_added.jpg" caption="Added effects." class="docs-img" >}}
...
## Adding the recording to a project

To add the recording to your project, you must first save it to disk.

Click the **"Save"** button, choose the destination folder and file name, and save the file with the **".wav"** extension.

After saving, the recording will automatically be added to the project.
