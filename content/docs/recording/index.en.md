...
{{< figure src="menu.jpg" link="menu.jpg" caption="Fig. 1 - Main menu option." class="docs-img" >}}

The following recording window will open.

{{< figure src="window.jpg" link="window.jpg" caption="Fig. 2 - Recording window." class="docs-img" >}}
...
{{< figure src="effects.jpg" link="effects.jpg" caption="Fig. 3 - Effects menu." class="docs-img" >}}
...
{{< figure src="effects_added.jpg" link="effects_added.jpg" caption="Fig. 4 - Added effects." class="docs-img" >}}
