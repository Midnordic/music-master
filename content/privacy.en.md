...
## 4. Microphone Access / Audio Recording

Music Master may request access to the device microphone only when the user uses features that record audio.

Recorded audio is used solely to provide this feature. Audio is stored only on the user’s device. 

Music Master does not upload, share, or sell recorded audio to third parties.

Microphone access is optional and used only when initiated by the user.
